...
for k = 1 : Time_out/Ts - 1
    ...
    if adv_true == 1
        ...
        true_params = [a11hat, a22hat, b11hat, b22hat];
        params_mat(k, :) = true_params;
    end
...
% plot(y(1, :))
% grid on
% title('Cart Position Adapt')
% 
% figure
% plot(y(2, :))
% grid on
% title('Angle of Pendulum phi Adapt')
% 
% figure
% stairs(Ck)
% 
% grid on
% title('Reference Input Adapt')
